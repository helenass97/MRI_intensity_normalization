...
#     nib.save(nib.Nifti1Image(img_norm, affine), os.path.join('C:/Users/helen/Desktop/norm_data_1mm/controls/t1/', filename)) 
...
#     img_norm = do_hist_normalization(img, perc, standard_scale) 
#     img_norm = img_norm/100
#     nib.save(nib.Nifti1Image(img_norm, affine), os.path.join('C:/Users/helen/Desktop/norm_data_1mm/controls/pet/', filename))
...
# #load images:
# im_norm_pet_p = nib.load('C:/Users/helen/Desktop/norm_data_1mm/patients/pet/mMR_BR1_002_MNI_nonlin.nii.gz')
# im_norm_t1_p = nib.load('C:/Users/helen/Desktop/norm_data_1mm/patients/t1/mMR_BR1_002_MNI_nonlin_1mm.nii.gz')

# im_norm_t1_c = nib.load('C:/Users/helen/Desktop/norm_data_1mm/controls/t1/AZAIS_MNI_nonlin_1mm.nii.gz')
# im_norm_pet_c = nib.load('C:/Users/helen/Desktop/norm_data_1mm/controls/pet/AZAIS_MNI_nonlin.nii.gz')
...
# plt.imshow(im_norm_pet_c[:,:,90])
# ax.set_title('PET norm controls')
# ax.get_xaxis().set_visible(False)
# ax.get_yaxis().set_visible(False)
# ax = fig.add_subplot(1, 2, 2)
# plt.imshow(im_norm_t1_c[:,:,90])
...
# f1 = axs[0].hist(im_norm_pet_c.flatten(), bins=64, range=(-1,2))
# f2 = axs[1].hist(im_norm_t1_c.flatten(), bins=64, range=(-1,2))
...
# fig= plt.figure()
# ax = fig.add_subplot(1, 2, 1)
# plt.imshow(im_norm_pet_p[:,:,90])
# ax.set_title('PET norm patients')
# ax.get_xaxis().set_visible(False)
# ax.get_yaxis().set_visible(False)
# ax = fig.add_subplot(1, 2, 2)
# plt.imshow(im_norm_t1_p[:,:,90])
...
# # plot histogram before and after: 
# fig, axs = plt.subplots(2, 1, constrained_layout=True)
# f1 = axs[0].hist(im_norm_pet_p.flatten(), bins=64, range=(-1,2))
# f2 = axs[1].hist(im_norm_t1_p.flatten(), bins=64, range=(-1,2))
